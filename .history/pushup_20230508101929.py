...
#     cv2.putText(frame, "count = " + str(count), (50, 100),
#                 cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 2)
#     cv2.putText(frame, "posture = " + str(posture), (50, 50),
#                 cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 2)
#     cv2.putText(frame, "Total Calories Burned: " + str(total_calories_burned), (50, 200),
